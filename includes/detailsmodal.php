	...
	<div class="modal-dialog modal-lg" role="document">
		<div class="modal-content">
				...
				<div class="container-fluid">
					<div class="row">
						...
						<div class="col-sm-6">
							...
							<hr>
							<p>In stock: <p id="available"><?php echo $product['qty'];?></p></p>
							<hr>
			...
			<div class="modal-footer">
				...
				<button onclick="add_to_cart(<?=$id;?>,<?=$qty;?>);return false;" class="btn btn-warning"><span class="glyphicon  glyphicon-shopping-cart"></span> Add to cart</button>
			</div>
		</div>
	</div>
</div><!-- /.modal -->
