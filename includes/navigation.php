...
<nav class="navbar navbar-default navbar-fixed-top navbar-expand-lg navbar-light bg-light">
    <div class="container">
      <!-- <a href="index.php" class="navbar-brand">Availawatch</a> -->
      ...
      <ul class="nav navbar-nav">
        ...
        <?php endwhile; ?>
        <li >
          <a href="cart.php"><span class="glyphicon glyphicon-shopping-cart"></span>Proceed to checkout</a>
        </li>
        ...
        <?php else:?>
          <li class="dropdown">
          <a href="#" class="dropdown-toggle" data-toggle="dropdown">Welcome,  <?php echo $user_data['first']; ?>!<span class="caret"> </span</a>
          <ul class="dropdown-menu" role="menu">
            <li><a href="change_detail.php">Update profile</a></li>
