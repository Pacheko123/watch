<?php
	...
	if (isset($_GET['add'])) {
		...
		?>
			...
			<form class="" action="users.php?add=1" method="post">
				...
				<div class="form-group col-md-6 ">
					<label for="telefon"><h2>Phone:</h2></label>
					<input type="text" name="telefon" id="telefon" class="form-control" value="<?=$telefon;?>">
				</div>
				<div class="form-group col-md-6 ">
					<label for="adresa"><h2>Location:</h2></label>
					<input type="text" name="adresa" id="adresa" class="form-control" value="<?=$adresa;?>">
				</div>
				<div class="form-group col-md-6 ">Assign permission!
					<label for="permisiuni">Permmission:</label>
  ...
  <h2>Users</h2>
	<a href="users.php?add=1" class="pull-right btn btn-success" id="add_product_btn">Add new user</a>
	<br>
	<hr>
