		...
		if($_POST) {
			...
			if(!empty($_FILES)) {
				...
				if($fileSize > 15000000) {
					$errors[] .= 'File must be greater less than 15 MB.';
				}
...
<!-- Form -->
<h2 class="text-center"><?php echo ((isset($_GET['edit']))?'Editeaza' : 'Add'); ?> Products</h2>
<hr>
...
<form class="form" action="products.php?<?php echo ((isset($_GET['edit']))?'edit='.$edit_id : 'add=1'); ?>" method="post" enctype="multipart/form-data">
  ...
  <div class="form-group col-md-3">
		...
		<div class="form-group col-md-3">
			<label for="child">Subcatgory:*</label>
	...
	<div class="form-group col-md-3">
		<label for="list_price">Official price:</label>
		<input class="form-control" type="text" name="list_price" id="list_price" value="<?php echo $list_price?>">
	</div>
	<div class="form-group col-md-3">
		<label for="qty">Quantity</label>
		<input id="qty" type="number" name="qty" min="0" class="form-control"  value="<?php echo $qty ?>" required>
	</div>
	...
	<div class="form-group col-md-6">
		...
		<textarea class="form-control" name="description" id="description" rows="6"><?php echo $description ?></textarea required>
	</div>
	<div class="form-group pull-right clearfix">
		<a class="btn btn-default" href="products.php">Cancel</a>
		<input class="btn btn-success" type="submit" value="<?php echo ((isset($_GET['edit']))?'Editeaza' : 'Add'); ?> Products">
	</div>
...
<!-- Table -->
<h2 >Products</h2>
<a class="btn btn-success pull-right" id="add_product_btn" href="products.php?add=1">Add new product</a>
<div class="clearfix"></div>
<hr>
