...
//editare
  ...
  <h2 class="text-center">Manage brands</h2><hr>
  <!-- form producator-->
  <div class="text-center">
    <form class="form-inline" action="brands.php<?=((isset($_GET['edit']))?'?edit='.$edit_id:'');?>" method="post">
      <div class="form-group">
        ...
        <label for="brand"><?=((isset($_GET['edit']))?'Editeaza':'Add');?> brand</label>
        ...
        <?php endif;?>
        <input type="submit" name="add_submit" value="<?=((isset($_GET['edit']))?'Editeaza':'Add');?> brand" class="btn btn-success">
      </div>
    </form>
  </div><hr>
